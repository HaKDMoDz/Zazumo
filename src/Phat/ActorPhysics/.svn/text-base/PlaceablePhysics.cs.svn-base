...
{
    public class PlaceablePhysics : PhysicsBase
    {
        private readonly Actor _actor;
        private IConcreteWorldObject _resource;
        private Body _body;

        public PlaceablePhysics(Actor actor, IResourceDictionary resourceDictionary)
        ...
        {
            this._resource = initializationData as IConcreteWorldObject;
        }
    }
}
