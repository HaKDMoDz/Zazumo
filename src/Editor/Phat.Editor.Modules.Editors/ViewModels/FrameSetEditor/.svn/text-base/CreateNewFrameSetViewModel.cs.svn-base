...
{
    [Export]
    public class CreateNewFrameSetViewModel : NotificationObject
    {
        ...
        public CreateNewFrameSetViewModel(IPackageRepository packageRepository, IEventAggregator eventAggregator)
        {
        ...
        private void CreateDefaultName()
        {
            ...
            while (true)
            {
                String name = String.Format("{0}.{1}.{2}{3}", PackageName.Replace(' ', '_'), "FrameSets", "FrameSet", uniqueNameNumber);
