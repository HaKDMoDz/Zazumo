...
{
    [Export]
    public class CreateNewTerrainTileDefinitionViewModel : NotificationObject
    {
        ...
        public CreateNewTerrainTileDefinitionViewModel(IPackageRepository packageRepository, IEventAggregator eventAggregator)
        {
        ...
        private void CreateDefaultName()
        {
            ...
            while (true)
            {
                String name = String.Format("{0}.{1}.{2}{3}", PackageName.Replace(' ', '_'), "TerrainTiles", "TerrainTile", uniqueNameNumber);
