...
{
    [Export]
    public class CreateNewLevelViewModel : NotificationObject
    {
        ...
        public CreateNewLevelViewModel(IPackageRepository packageRepository, IEventAggregator eventAggregator)
        {
        ...
        private void CreateDefaultName()
        {
            ...
            while (true)
            {
                String name = String.Format("{0}.{1}.{2}{3}", PackageName.Replace(' ', '_'), "Levels", "Level", uniqueNameNumber);
