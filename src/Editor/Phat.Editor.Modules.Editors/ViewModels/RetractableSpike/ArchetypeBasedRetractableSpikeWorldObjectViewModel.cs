...
{
    public class ArchetypeBasedRetractableSpikeWorldObjectViewModel : ArchetypeBasedConcreteWorldObjectViewModel
    {
        ...
        {
            var model = new ArchetypeBasedRetractableSpikeWorldObject();
