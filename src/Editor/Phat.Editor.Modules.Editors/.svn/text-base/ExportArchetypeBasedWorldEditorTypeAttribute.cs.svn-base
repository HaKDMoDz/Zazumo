...
namespace Phat.Editor.Modules.Editors
{
    ...
    public class ExportArchetypeBasedWorldEditorTypeAttribute : ExportAttribute
    {
        /// <summary>
        ...
        public ExportArchetypeBasedWorldEditorTypeAttribute(String propertiesView)
            : base(typeof(IArchetypeBasedWorldEditorTypeDefinition))
        {
    ...
    /// </summary>
    public interface IArchetypeBasedWorldEditorTypeMetaData
    {
