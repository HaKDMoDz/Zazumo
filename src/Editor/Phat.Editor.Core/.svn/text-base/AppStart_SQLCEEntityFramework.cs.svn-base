...
[assembly: WebActivator.PreApplicationStartMethod(typeof(Phat.Editor.AppStart_SQLCEEntityFramework), "Start")]
...
namespace Phat.Editor {
    ...
    public abstract class SqlCeInitializer<T> : IDatabaseInitializer<T> where T : DbContext {
        ...
        private static string ReplaceDataDirectory(string inputString) {
            ...
            string data = @"..\..\..\src\Content"; //AppDomain.CurrentDomain.GetData("DataDirectory") as string;
